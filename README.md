...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/eth-event-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12034&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/eth-event-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `eth-event` can be installed with:

```
conda install eth-event
```

It is possible to list all of the versions of `eth-event` available on your platform with:
